...
function peg$parse(input, options) {
  ...
  var peg$f3 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f4 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f5 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f6 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f7 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f8 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f9 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f10 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f11 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f12 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f13 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f14 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f15 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f16 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f17 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f18 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f19 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f20 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f21 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f22 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f23 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f24 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f25 = function(token, _) { return node('literal', { literal: token, wsEnd: _ }); };
  var peg$f26 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f27 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f28 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f29 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f30 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f31 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f32 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f33 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f34 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f35 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f36 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f37 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f38 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f39 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f40 = function(wsStart, token, wsEnd) { return node('literal', { literal: token, wsStart, wsEnd }); };
  var peg$f41 = function(identifier, _) { return node('identifier', { identifier, wsEnd: _ }); };
  var peg$f42 = function(identifier) { return node('identifier', { identifier }); };
  ...
  var peg$f58 = function(ifPart, elseIfParts, elsePart, endif, wsEnd) { // optional because the program can end with endif
